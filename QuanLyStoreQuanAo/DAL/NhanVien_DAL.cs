...
namespace DAL
{
    public class NhanVien_DAL
    {
        ...
        {
            return context.NhanViens.FirstOrDefault(nv => nv.MaNhanVien.Equals(maNV));
        }
        //Lấy nhân viên bằng Email
        public NhanVien GetNhanVienByEmail(string email)
        {
            return context.NhanViens.FirstOrDefault(nv => nv.Email.Equals(email));
        }
        //Lấy mã nhân viên bằng SDT
        public string GetMaNVBySDT(string sdt)
        {
            var nhanvien = context.NhanViens.FirstOrDefault(nv => nv.SoDienThoai.Equals(sdt));
