...
namespace DAL
{
    public class KhachHang_DAL
    {
        ...
        {
            return context.KhachHangs.Select(kh => kh).ToList();
        }

        //Lấy Khách hàng cuối
        public KhachHang GetLastKhachHang()
        {
            return context.KhachHangs.OrderByDescending(kh => kh.MaKhachHang).FirstOrDefault();
        }

        //Lấy mã khách hàng bằng số điện thoại
        public string GetMaKHBySDT(string sdt)
        {
            var khachhang = context.KhachHangs.FirstOrDefault(kh => kh.SoDienThoai.Equals(sdt));
        ...
        {
            return context.KhachHangs.Any(kh => kh.SoDienThoai.Equals(sdt));
        }
        //Thêm khách hàng
        ...
        {
            return context.KhachHangs.Any(kh => kh.MaKhachHang == maKH);
        }
    }
}
